      ...
      try {
        ...
        const mapped = raw.map((p) => normalizeExpertAccess({
         ...
         pricing_modes: p.pricing_modes || [],
          ...
          show_chat_button_on_profile_page: p.show_chat_button_on_profile_page,
          showChatButtonOnProfilePage: p.showChatButtonOnProfilePage,
          show_call_button_on_profile_page: p.show_call_button_on_profile_page,
          showCallButtonOnProfilePage: p.showCallButtonOnProfilePage,
          show_video_button_on_profile_page: p.show_video_button_on_profile_page,
          showVideoButtonOnProfilePage: p.showVideoButtonOnProfilePage,
          show_video_call_button: p.show_video_call_button,
          showVideoCallButton: p.showVideoCallButton,
    ...
    try {
     ...
     const data = res?.data?.data;
      ...
      setExpertData({
        ...
        can_video_call: normalizedData.can_video_call,
        canVideoCall: normalizedData.canVideoCall,
        ...
        show_video_button: normalizedData.show_video_button,
        showVideoButton: normalizedData.showVideoButton,
        show_chat_button_on_profile_page: normalizedData.show_chat_button_on_profile_page,
        showChatButtonOnProfilePage: normalizedData.showChatButtonOnProfilePage,
        show_call_button_on_profile_page: normalizedData.show_call_button_on_profile_page,
        showCallButtonOnProfilePage: normalizedData.showCallButtonOnProfilePage,
        show_video_button_on_profile_page: normalizedData.show_video_button_on_profile_page,
        showVideoButtonOnProfilePage: normalizedData.showVideoButtonOnProfilePage,
        show_video_call_button: normalizedData.show_video_call_button,
        showVideoCallButton: normalizedData.showVideoCallButton,
