    ...
    <>
      ...
      <header className="mobile-header-only">
        <div className="mobile-header-inner">
          ...
          >
            <Menu size={24} strokeWidth={2} color="currentColor" fill="none" className="header-outlined-icon" />
          </button>
          ...
          <div className="mobile-header-location-box" onClick={onLocationSelect}>
            <div className="mobile-header-location-top">
              ...
              <ChevronDown size={10} className="location-caret-icon" color="currentColor" />
            </div>
          ...
          <div className="mobile-header-right-actions">
            ...
            >
              <Wallet size={22} strokeWidth={1.8} color="currentColor" fill="none" className="header-outlined-icon" />
              {walletAmount > 0 ? (
            ...
            >
              <Bell size={22} strokeWidth={1.8} color="currentColor" fill="none" className="header-outlined-icon" />
