          ...
          <ExpenseSection>
            <SectionTitle>
              ...
              <div className="filter">
                <button className={filterType === "thisMonth" ? "active" : ""} onClick={() => setFilterType("thisMonth")}>This Month</button>

                <button className={filterType === "lastMonth" ? "active" : ""} onClick={() => setFilterType("lastMonth")}>Last Month</button>

                <button className={filterType === "custom" ? "active" : ""} onClick={() => setFilterType("custom")}>Custom Range</button>

                <button className={filterType === "all" ? "active" : ""} onClick={() => setFilterType("all")}>All Time</button>
              </div>
            </SectionTitle>
