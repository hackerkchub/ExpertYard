...
export default function InvoiceTab({ snapshot, workspace }) {
  ...
  return (
    <div className="tab-invoice">
      <h3 className="tab-panel-title">GST Tax Invoice Receipt</h3>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '1.5rem' }}>
          ...
          <tbody>
            <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
              ...
              <td style={{ padding: '0.75rem', textAlign: 'right' }}>₹{fin.effective_base_amount || 0}</td>
            </tr>
            <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
              <td style={{ padding: '0.75rem' }}>GST Tax (18%)</td>
              <td style={{ padding: '0.75rem', textAlign: 'right' }}>₹{fin.gst_amount || 0}</td>
            </tr>
